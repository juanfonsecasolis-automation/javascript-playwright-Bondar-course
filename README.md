...
## Disclaimer
Maintenability is one important aspect on successful end-to-end automation solutions. It is determined, among other factors, by the chosen programming language, test tool, and test framework. Given this is a repository containing a JavaScript (JS) test solution, I would like to refer to the language (I won't discuss about Playwright). Below are some criterias suggested by authors to choose the right programming language [2].
